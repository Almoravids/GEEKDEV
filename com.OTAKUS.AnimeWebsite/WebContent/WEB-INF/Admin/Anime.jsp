...
<center>
		<header id="nav">
		<ul>
			<li><a href="#" id="addOnglet" onclick="changeState(this)">Add Anime</a></li>
			
			<li><a href="#" id="modOnglet" onclick="changeState(this)">Update Anime</a></li>
			
			<li><a href="#" id="delOnglet" onclick="changeState(this)">Delete Anime</a></li>
		</ul>
		</header>
<section>
<center><form  id="add" action="anime" method="post">
<h2>Add Anime</h2>
<input type="hidden" name="op" value="add">
<table>
<tr><td><label for="name">Name</label></td><td><input type="text" id="name" name="name" placeholder="name" required/></td></tr>
<tr><td><label for="desc">Description : </label></td><td><textarea rows="4"id="desc" name="desc" placeholder="description" required></textarea>
</td></tr>
...
<%}}catch (Exception e){
  ...
  <input type="button" id="bType"  name="add" value="Select" onclick="typeOnClick(this.name);">
</td></tr>
<tr><td><label for="types">Types : </label></td><td><textarea id="types" name="types" placeholder="types" required></textarea>
</td></tr>
...
<tr><td><label for="allia">Alias : </label></td><td><input type="text" id="allia" /><input type="button" id="bAllia" name="add" value="Select" onclick="aliasOnClick(this.name);">
</td></tr>
<tr><td><label for="allias">Alias Selected: </label></td><td><textarea id="allias" name="allias" placeholder="allias" required></textarea>
</td></tr>
<tr><td><label for="imgLink">Image Link : </label></td><td><input type="text" id="imgLink" name="imgLink" placeholder="Link" required/>
</td></tr>
</table>
...
<table>
<tr><td><label for="upname">Name</label></td><td><select id="upname" name="upname" onchange="a(this);">
 <option value="" disabled selected>Select Anime</option>
<%	h=(Method)Method.getcontext();
for (Anime a:h.getAnimes()){%>
...
<tr><td><label for="allia">Alias : </label></td><td><input type="text" id="allia" /><input type="button" id="bAllia" name="mod" value="Select" onclick="aliasOnClick(this.name);">
</td></tr>
<tr><td><label for="allias">Alias Selected: </label></td><td><textarea id="allias" name="allias" placeholder="allias" required></textarea>
</td></tr>
<tr><td><label for="imgLink">Image Link : </label></td><td><input type="text" id="imgLink" name="imgLink" placeholder="Link" required/>
...
<table>
<tr><td>
<label for="name">Name</label></td><td><select name="animename">
<%	h=(Method)Method.getcontext();
...
function typeOnClick(name){
	checkAreasOption(document.querySelector('#'+name+' #type'), document.querySelector('#'+name+' #types'));};
function aliasOnClick(name){
	checkAreasTF(document.querySelector('#'+name+' #allia'), document.querySelector('#'+name+' #allias'));
}
...
function checkAreasTF(a,as){
	...
	var xhttp = new XMLHttpRequest(); 
	  ...
	  xhttp.open("GET","../Listener.jsp?getAnime="+escape(a.value));
	  xhttp.send();}
};
</script>
</body>
