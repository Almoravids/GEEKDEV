...
public interface IMovieDao {
	...
	public Movie get(Integer animeId,Integer movieNum) throws DataAccessException, ClassNotFoundException, SQLException;

	// public T getLast(S animeId) throws DataAccessException,
